...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Apr 29 21:27:32 2017
# Project:  hw8.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile hw8.pro
#############################################################################
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/hw81.0.0/ && $(COPY_FILE) --parents book.h clothing.h comparators.h datastore.h db_parser.h hash.h heap.h movie.h msort.h multiwin.h mydatastore.h product.h product_parser.h review.h user.h util.h .tmp/hw81.0.0/ && $(COPY_FILE) --parents amazon.cpp book.cpp clothing.cpp db_parser.cpp movie.cpp multiwin.cpp mydatastore.cpp product.cpp product_parser.cpp user.cpp util.cpp .tmp/hw81.0.0/ && (cd `dirname .tmp/hw81.0.0` && $(TAR) hw81.0.0.tar hw81.0.0 && $(COMPRESS) hw81.0.0.tar) && $(MOVE) `dirname .tmp/hw81.0.0`/hw81.0.0.tar.gz . && $(DEL_FILE) -r .tmp/hw81.0.0
